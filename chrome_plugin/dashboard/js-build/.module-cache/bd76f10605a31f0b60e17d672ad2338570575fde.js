  ...
  render: function() {
    ...
    return (
      React.createElement("li", null, 
        React.createElement("div", {className: "zb-list-row-area zb-clearfix"}, 
          React.createElement("ul", {className: "zb-list-row"}, 
            React.createElement("li", {className: "zb-receiver"}, 
              React.createElement("span", null, receiver)
            ), 
            React.createElement("li", {className: "zb-subject"}, 
              React.createElement("span", null, this.props.data.subject)
            ), 
            React.createElement("li", {className: "zb-detail"}, 
...
var ListContent = React.createClass({displayName: "ListContent",
  render: function() {
    ...
    return (
      React.createElement("ul", {className: "zb-list-content"}, 
        React.createElement("li", null, 
          React.createElement("div", {className: "zb-list-head-area zb-clearfix"}, 
            React.createElement("ul", {className: "zb-list-head"}, 
              React.createElement("li", {className: "zb-head zb-head-receiver"}, React.createElement("span", null, "Email")), 
              React.createElement("li", {className: "zb-head zb-head-subject"}, React.createElement("span", null, "Subject")), 
              React.createElement("li", {className: "zb-head zb-head-details"}, React.createElement("span", null, "Details"))
            )
          )
        ), 
        listNodes
...
var SignalApp = React.createClass({displayName: "SignalApp",
  ...
  showDashboard: function(settings) {
    var self = this;
